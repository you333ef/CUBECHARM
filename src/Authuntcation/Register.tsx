...
const Register = () => {
  ...
  // Watch password input for confirm password validation
      ...
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl px-6 py-6 mx-auto">
        ...
        <div className="text-center mb-5">
          <p className="text-[#6B7280] text-sm">
            Join CUBECHORM and start exploring properties
          </p>
        </div>
        ...
        <div className="flex items-center my-4">
          ...
          <span className="px-2 text-xs text-gray-400">REGISTER WITH EMAIL</span>
          <div className="flex-grow border-t border-gray-200"></div>
        </div>
